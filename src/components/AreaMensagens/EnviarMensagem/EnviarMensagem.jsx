...
class EnviarMensagem extends Component {
    ...
    novaMensagem(event){
        ...
        if(this.mensagem.trim() != ""){
            this.props.novaMensagem(this.mensagem.trim(), this.dataFormatada())
            this.mensagem = "";
            this.limpaCampos()
        }
    }
    ...
    limpaCampos(){
        let doc = document.getElementById("inputMensagem")
        doc.value = ""
    }
    ...
    render() { 
        return (  
            <div className="enviarmensagem_container">
                ...
                <form onSubmit={this.novaMensagem.bind(this)} className="send_box">
                    ...
                    <input
                        ...
                        onChange={this.handleMudancaMensagem.bind(this)}
                    />
                    
                </form>
                <svg onClick={this.novaMensagem.bind(this)} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"><path fill="currentColor" d="M1.101 21.757L23.8 12.028 1.101 2.3l.011 7.912 13.623 1.816-13.623 1.817-.011 7.912z"></path></svg>
            </div>
        );
    }
}

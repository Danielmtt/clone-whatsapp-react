...
class Cabecalho extends Component {
    render() { 
        return (  
            <div className="cabecalho_areamensagem_container"> 
                <div className="dados">
                    <img src={this.props.contato.picture} alt=""/>
                    
                    <div className="dados_info">
                        <p className="nome">{this.props.contato.name}</p>
                        <p className="status">{this.props.contato.status}</p>
                    </div>
                </div>
